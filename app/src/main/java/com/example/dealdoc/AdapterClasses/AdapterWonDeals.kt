...
import com.example.dealdoc.fragments.fragment_tab_won.Companion.adapter
...
class AdapterWonDeals(private val dealList: ArrayList<ModelClassForDeal>) :
    RecyclerView.Adapter<AdapterWonDeals.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        Log.v("dealStatus",""+ItemsViewModel.status)
        ...
        holder.tvDealClosedDate.text = changeDateFormat(ItemsViewModel.closedDate)
            ...
            holder.IVMenu.setOnClickListener {
                ...
                val menuItem = popupMenu.menu.findItem(R.id.action_win)
