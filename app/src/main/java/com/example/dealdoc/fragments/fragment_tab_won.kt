...
import com.example.dealdoc.fragments.fragment_tab_won.Companion.data
import com.example.dealdoc.fragments.fragment_tab_won.Companion.token
...
class fragment_tab_won : Fragment() {
    ...
    var token = ""
        ...
        lateinit var adapter: AdapterWonDeals
    }
    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
       val view = inflater.inflate(R.layout.fragment_tab_won, container, false)
        ...
        recyclerview = view.findViewById(R.id.WonDeals_RV)
        progressbar = view.findViewById(R.id.progressBar_WonDeals)
        recyclerview.layoutManager = LinearLayoutManager(context)
        val swipeRefreshLayout: SwipeRefreshLayout = view.findViewById(R.id.RefreshrecyclerWonDeals)
...
//                    Log.v("Deal_data",""+response.body().toString())
                            ...
                            if (response.isSuccessful) {
                                ...
                                val itemTouchHelper =
                                    ItemTouchHelper(SwipeToDeleteWonDeal(adapter, "#FF0000"))
...
class SwipeToDeleteWonDeal(private val adapter: AdapterWonDeals, private val backgroundColor: String) :
